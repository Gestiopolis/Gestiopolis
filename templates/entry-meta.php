...
<ul class="list-unstyled">
  ...
  foreach($categories as $category){
    echo '<li class="catego cat-col-'.$category->term_id.'"><i class="fa icon-cat-'.$category->term_id.'"></i> <a cat-col-'.$category->term_id.' href="'.get_category_link($category->term_id ).'">'.$category->cat_name.'</a></li>';
  }
  ?>
